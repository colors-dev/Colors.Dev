...
[![Version](https://img.shields.io/badge/version-6.8.23.0218-blue.svg)](https://github.com/colors-dev/Colors.Dev)
...
## Version History
- **6.8.23.0218** - Current release
  - **Update**: Tweaked CMYK Modifier between Gray and Taupe.  Also tweaked the Cyan, Magenta, Yellow, and as Magenta was taking over Violet colors.
